...
def positionToIndex2(r): # version 2 (return the sign for the antiperiodic condition)
    sgn=1
    rx=r[0]
    ry=r[1]
...
def indexToDeltaVector(idx): # for d-wave SC correlation function
...
for i in range(Nsite):
    for j in range(Nsite):
        for s in range(2):
            for t in range(2):
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,i,s,j,t,j,t))
for i in range(Nsite):
    for j in range(Nsite):
        f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,0,j,0,j,1,i,1))
        f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,1,j,1,j,0,i,0))
for i in range(Nsite):
    for j in range(Nsite):
        f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,0,j,0,i,1,j,1))
...
for i in range(Nsite):
    ...
    for j in range(Nsite):
        ...
        for s in range(1):
            for t in range(1):
                t = 1-t
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i1,t,j1,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i1,t,j2,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i1,t,j3,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i1,t,j4,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i2,t,j1,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i2,t,j2,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i2,t,j3,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i2,t,j4,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i3,t,j1,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i3,t,j2,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i3,t,j3,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i3,t,j4,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i4,t,j1,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i4,t,j2,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i4,t,j3,t))
                f.write("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\n".format(i,s,j,s,i4,t,j4,t))
